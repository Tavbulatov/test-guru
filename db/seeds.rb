...
answers = Answer.create([{body: '12', correct: true, question_id: questions[0].id},
                         ...
                         {body: 'Жаропонижающий,разжижает кровь,противоспалительное', correct: true, question_id: questions[4].id},
                         ...
                         {body: 'При травмах закрытого типа и воспалениях, устраняет болевой синдром', correct: true, question_id: questions[5].id},
                         {body: 'Для обработки ран как противомикробное, регенерирующее', question_id: questions[5].id},
